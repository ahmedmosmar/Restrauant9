            ...
            <form action="{{route('update-buy',$buy->id)}}" method="POST" class="form-add-buys">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-controll" placeholder=" أدخل الوحدة من فضلك"
                            value="{{$buy->unit}}" name="unit" autocomplete="off" required>
                        @error('unit')
                        <small class="form-text text-danger small-text">{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-controll" placeholder=" أدخل الكمية من فضلك"
                            value="{{$buy->amount}}" id="amount" name="amount" autocomplete="off" required>
                        @error('amount')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-controll" placeholder=" المبلغ الكلي "
                            value="{{$buy->final_price}}" id="finalPrice" name="final_price" autocomplete="off">
                        @error('final_price')
                        <small class="form-text text-danger small-text">{{$message}}</small>
                        @enderror
                    </div>
